...
```cpp
class Dog {public:    std::string name;    
int age;        
std::string bark() {        
...
```cpp
class Car {public:    std::string brand;    
int year;
        std::string getInfo() {        
...
```cpp
Car car1;car1.brand = "Tesla";
car1.year = 2023;Car car2;
car2.brand = "Honda";car2.year = 2020;
